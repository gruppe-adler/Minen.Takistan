...
player createDiaryRecord ["Diary", ["militärische Lage", "Rechen Sie überall mit Feindkontakt, besonders in der Nähe von Talibanhochburgen. Alle Straßen gelten von Minen geräumt,
 außer der Straße die Sie räumen sollen und die Straßen, die durch das Minenfeld östlich von Feruz-Abad führen, achten sie aber auch auf den anderen Straßen und dem offenen Gelände auf Minen. Östlich ihres Einsatzgebietes operieren US-Spezialkräfte. Betreten sie das Operationsgebiet nicht."]];
player createDiaryRecord ["Diary", ["Auftrag", "Räumen Sie alle Minen auf dem Highway ab dem Grüne-Marker bis Feruz-Abad. Anschließend neutralisieren sie den lokalen Warlord, der in Feruz-Abad vermutet wird. Kehren Sie anschließend zu ihrer Basis zurück.
 In den Reihen der Afghane wird ein Schläfer der Taliban vermutet, versuchen sie diesen zu identifizieren und auszuschalten. Gehen sie aber vorsichtig vor, da unsere Regierung sich zurzeit in einer diplomatische Krise mit den Afghane befindet."]];
...
player createDiaryRecord ["Diary", ["militärische Lage", "Rechen Sie überall mit Feindkontakt, besonders in der Nähe von Talibanhochburgen. Alle Straßen gelten von Minen geräumt,
 außer der Straße die Sie räumen sollen und die Straßen, die durch das Minenfeld östlich von Feruz-Abad führen, achten sie aber auch auf den anderen Straßen und dem offenen Gelände auf Minen. Östlich ihres Einsatzgebietes operieren US-Spezialkräfte. Betreten sie das Operationsgebiet nicht."]];
player createDiaryRecord ["Diary", ["Auftrag", "Räumen Sie alle Minen auf dem Highway ab dem Grüne-Marker bis Feruz-Abad. Anschließend neutralisieren sie den lokalen Warlord, der in Feruz-Abad vermutet wird.
 In den Reihen der Afghane wird ein Schläfer der Taliban vermutet, versuchen sie diesen zu identifizieren und auszuschalten. Gehen sie aber vorsichtig vor, da unschuldige Opfer vermieden werden sollen."]];
